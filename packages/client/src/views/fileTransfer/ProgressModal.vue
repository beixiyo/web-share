    ...
    <div class="size-full flex flex-col gap-4 rounded-2xl p-4 sm:gap-3 sm:p-3">
      ...
      <div class="flex items-center space-x-4 sm:space-x-3">
        ...
        <div class="min-w-0 flex-1">
          <h3 class="text-lg text-gray-900 font-semibold sm:text-base dark:text-gray-100">
            文件传输
          </h3>
          <div class="truncate text-sm text-gray-500 sm:text-xs dark:text-gray-400">
            正在传输第
            <span class="text-emerald-600 font-medium dark:text-emerald-400">{{ progress.curIndex + 1 }}</span>
            个文件，共
      ...
      <div class="rounded-lg bg-gray-50 p-3 dark:bg-gray-700/50 sm:p-2">
        <div class="mb-2 flex items-center justify-between sm:mb-1">
          ...
          <span class="flex-shrink-0 rounded bg-white px-2 py-1 text-xs text-gray-500 dark:bg-gray-600 sm:px-1.5 sm:text-[10px] dark:text-gray-300">
      ...
      <div class="space-y-3 sm:space-y-2">
        ...
        <div>
          <div class="mb-1 flex items-center justify-between">
            <span class="text-sm text-gray-700 font-medium sm:text-xs dark:text-gray-300">当前文件进度</span>
            <span
              class="text-sm text-emerald-600 font-medium sm:text-xs dark:text-emerald-400"
            >{{ numFixed(progress.progress * 100) }}%</span>
          </div>
          <div class="h-2 w-full rounded-full bg-gray-200 sm:h-1.5 dark:bg-gray-600">
            <div
        ...
        <div>
          <div class="mb-1 flex items-center justify-between">
            <span class="text-sm text-gray-700 font-medium sm:text-xs dark:text-gray-300">总体进度</span>
            <span
